                      ...
                      >
                        <CardHeader className="relative">
                          <div className="flex items-center justify-between mb-2">
                            <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${method.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                              <IconComponent className="w-6 h-6 text-white" />
                            </div>
                            {method.popular && (
                              <span className="bg-figuro-accent/90 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-full border border-white/20">
                                Popular
                              </span>
                            )}
                            {method.new && (
                              <span className="bg-green-500/90 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-full border border-white/20">
                                New
                              </span>
                            )}
                          </div>
