    ...
    <section className="pt-32 pb-20 relative overflow-hidden min-h-screen flex items-center justify-center">
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500/10 to-figuro-accent/10 border border-green-400/20 rounded-full px-6 py-3 mb-6"
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {examplePrompts.map((example, index) => (
                  <motion.button
                    ...
                    className="text-xs bg-white/5 hover:bg-white/10 border border-white/10 hover:border-figuro-accent/50 rounded-full px-3 py-1.5 text-white/70 hover:text-white transition-all duration-300"
