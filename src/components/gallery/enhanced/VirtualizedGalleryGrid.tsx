...
const VirtualizedGalleryGrid: React.FC<VirtualizedGalleryGridProps> = ({
  ...
  // Use regular grid layout for now, can implement virtualization later if needed
  const gridCols = viewMode === "list" ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4";
