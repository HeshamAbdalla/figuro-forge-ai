...
import { Box, Users, Sparkles, TrendingUp } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/70 mb-8 leading-relaxed">
            Explore amazing 3D models created by our community. Get inspired by cutting-edge
            <br className="hidden md:block" />
            AI-generated art and share your own masterpieces.
          </p>
